...
class StationServer(QtCore.QObject):
    ...
    def startServer(self) -> None:
        ...
        while self.serverRunning:
            ...
            # TODO: Doesn't this get taken cared of in a different part of the code? (when actually broadcasting the new parameter)_
    ...
    def _broadcastParameterChange(self, blueprint: ParameterBroadcastBluePrint):
        ...
        # TODO: CHECK HERE CHECK HERE CHECK HERE CHECK HERE CHECK HERE
        #  Zacks code for the past 2 lines are:
